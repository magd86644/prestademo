...
class Ps_metricsAdminContainer extends Container
{
    ...
    {
        return $this->services['ps_accounts.facade'] = new \ps_metrics_module_v4_1_1\PrestaShop\PsAccountsInstaller\Installer\Facade\PsAccounts(${($_ = isset($this->services['ps_accounts.installer']) ? $this->services['ps_accounts.installer'] : ($this->services['ps_accounts.installer'] = new \ps_metrics_module_v4_1_1\PrestaShop\PsAccountsInstaller\Installer\Installer('5.0'))) && false ?: '_'});
    }
