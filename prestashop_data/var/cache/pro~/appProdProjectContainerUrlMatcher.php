...
class appProdProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/modules')) {
            ...
            // ps_accounts_oauth2
            if ('/modules/ps_accounts/oauth2' === $pathinfo) {
                $ret = array (  '_controller' => 'PrestaShop\\Module\\PsAccounts\\Controller\\Admin\\OAuth2Controller::initOAuth2FlowAction',  '_anonymous_controller' => true,  '_legacy_controller' => 'SfAdminOAuth2PsAccounts',  '_legacy_link' => 'SfAdminOAuth2PsAccounts',  '_route' => 'ps_accounts_oauth2',);
                if (!in_array($canonicalMethod, ['GET'])) {
                    $allow = array_merge($allow, ['GET']);
                    goto not_ps_accounts_oauth2;
                }

                return $ret;
            }
            not_ps_accounts_oauth2:

            // ps_accounts_login
            if ('/modules/ps_accounts/login' === $pathinfo) {
                $ret = array (  '_controller' => 'PrestaShop\\Module\\PsAccounts\\Controller\\Admin\\OAuth2Controller::displayLoginAction',  '_anonymous_controller' => true,  '_legacy_controller' => 'SfAdminLoginPsAccounts',  '_legacy_link' => 'SfAdminLoginPsAccounts',  '_route' => 'ps_accounts_login',);
                if (!in_array($canonicalMethod, ['GET'])) {
                    $allow = array_merge($allow, ['GET']);
                    goto not_ps_accounts_login;
                }

                return $ret;
            }
            not_ps_accounts_login:
