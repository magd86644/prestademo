...
class KlaviyoV3Api
{
    ...
    const KLAVIYO_V3_REVISION_JUL_2024 = '2024-07-15';
    ...
    public function createBackInStockSubscription($email, $catalogVariantId)
    {
        ...
        return $this->requestV3('/api/back-in-stock-subscriptions/', self::HTTP_POST, $body, 0, self::KLAVIYO_V3_REVISION_JUL_2024);
    }
